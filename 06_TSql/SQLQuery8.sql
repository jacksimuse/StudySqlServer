...
insert into testTBL1 (id, userName) values (2, '최재훈');
insert into testTBL1 values (3, '홍길순', 26);
insert into testTBL1 (age, ID) values (30, 4);
insert into testTBL1 (userName, age) values ('설현', 23);

insert into testTBL1 values ('성시경', 30);
